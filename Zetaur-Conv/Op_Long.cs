...
namespace Zetaur_Conv
{
    ...
    public class Op_Long
    {
        ...
        /// <returns>Devuelve un array con los valores convertidos (Km, M, Nmi, in, Yd, ft)</returns>
        ...
        /// <returns>Devuelve un array con los valores convertidos (Km, m, Mi, in, Yd, ft)</returns>
        ...
        /// <returns>Devuelve un array con los valores convertidos (Km, m, Mi, Nmi, Yd, ft)</returns>
        ...
        /// <returns>Devuelve un array con los valores convertidos (Km, m, Mi, Nmi, in, ft)</returns>
        ...
        /// <returns>Devuelve un array con los valores convertidos (Km, m, Mi, Nmi, in, Yd)</returns>
